...
public class ClientHandle implements Runnable {
    public LinkedBlockingQueue<byte[]> sendQueue = new LinkedBlockingQueue<byte[]>();
    public LinkedBlockingQueue<byte[]> receiveQueue = new LinkedBlockingQueue<byte[]>();
